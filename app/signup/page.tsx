      ...
      <Card className="w-full max-w-sm shadow-xl p-2 rounded-2xl">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input onChange={(e)=>{setPassword(e.target.value)}}  type="password" placeholder="Create a password" />
          </div>

          <Button onClick={handleSignUp} className="w-full mt-4 py-2 rounded-xl">Create Account</Button>
